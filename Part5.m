...
subplot(1,2,1);hold on;plot(test1(1),test1(2),'yx', 'markersize',10','linewidth',2); title('Epipolar line from fundamental matrix')
subplot(1,2,2);hold on;plot(xTest,yTest,'y.', 'markersize',10','linewidth',2)

%% Epipolar line 2 from F2
test1 = [673;372;1]
...
for i = 1:4
    ...
    subplot(1,nImages,2)
    hold on;plot(x(1,:),x(2,:),'.', 'color', plotMarker(i), 'markersize',5','linewidth',3); title('Epipolar lines from estimated parameters')
end
